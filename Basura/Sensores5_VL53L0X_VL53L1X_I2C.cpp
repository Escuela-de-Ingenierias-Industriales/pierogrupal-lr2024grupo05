/*
 * File: Sensores5_VL53L0X_VL53L1X_I2C.cpp
 *
 *
 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Fri Dec 27 16:33:05 2024
 */

#define S_FUNCTION_LEVEL               2
#define S_FUNCTION_NAME                Sensores5_VL53L0X_VL53L1X_I2C
...
/* Output Port  0 */
#define OUT_PORT_0_NAME                Sensor
#define OUTPUT_0_DIMS_ND               {1,5}
...
{
  real_T *Sensor = (real_T *) ssGetOutputPortRealSignal(S, 0);
  real_T *Status = (real_T *) ssGetOutputPortRealSignal(S, 1);
  const real_T *xD = ssGetDiscStates(S);
  Sensores5_VL53L0X_VL53L1X_I2C_Outputs_wrapper(Sensor, Status, xD);
}
...
static void mdlUpdate(SimStruct *S, int_T tid)
{
  ...
  Sensores5_VL53L0X_VL53L1X_I2C_Update_wrapper(Sensor, Status, xD);
}
