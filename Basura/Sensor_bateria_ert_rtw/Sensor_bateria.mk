###########################################################################
## Makefile generated for component 'Sensor_bateria'. 
## 
## Makefile     : Sensor_bateria.mk
## Generated on : Sun Dec 15 19:20:23 2024
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Sensor_bateria.elf
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Sensor_bateria.elf
...
DEFINES_STANDARD = -DMODEL=Sensor_bateria -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_AnalogInput.o ArduinoPinHandleMap.o xcp_ext_mode.o Sensor_bateria.o Sensor_bateria_data.o xcp_ext_common.o xcp_ext_classic_trigger.o xcp.o xcp_standard.o xcp_daq.o xcp_calibration.o xcp_fifo.o xcp_transport.o xcp_mem_default.o xcp_drv_rtiostream.o xcp_utils.o xcp_frame_serial.o xcp_ext_param_default_serial.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o platform_timer.o rtiostream_serial_daemon.o
...
%.o : $(START_DIR)/Sensor_bateria_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" $(subst /,\,"$<")


%.S.o : $(START_DIR)/Sensor_bateria_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" $(subst /,\,"$<")
...
%.o : $(START_DIR)/Sensor_bateria_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" $(subst /,\,"$<")
...
Sensor_bateria.o : $(START_DIR)/Sensor_bateria_ert_rtw/Sensor_bateria.c
	$(CC) $(CFLAGS) -o "$@" $(subst /,\,"$<")


Sensor_bateria_data.o : $(START_DIR)/Sensor_bateria_ert_rtw/Sensor_bateria_data.c
	$(CC) $(CFLAGS) -o "$@" $(subst /,\,"$<")


ert_main.o : $(START_DIR)/Sensor_bateria_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" $(subst /,\,"$<")
