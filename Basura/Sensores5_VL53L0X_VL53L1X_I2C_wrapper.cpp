...
VL53L0X sensorL0[7];
unsigned char pin_sensor[7]={45,47,49,51,53};
int nueva_direccion[7]={42,44,46,48,50};
...
if (xD[0]!=1)
{
    ...
    for(int i=45;i<=53;i++)    pinMode(i,OUTPUT);
    for(int i=45;i<=53;i++)   digitalWrite(i,LOW);
